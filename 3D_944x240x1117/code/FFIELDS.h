...
C                Units are           m^2/s^2
C     Dynmass :: dynamic mass change tendency expressed as m of ice-change/ area
C                in unit time. Units are m/s
C                NOTE: This value will be exported to the shelfice package and
C                read into shelfice_step_icemass.F as 'shelfIceMassDynTendency' term
...
C     Dynmass[0,1]  :: Temp. for ice-mass change at interface due to tides
...
#endif
#ifdef IGZ_INTRUSIONS
      _RS Dynmass0  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RS Dynmass1  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
#endif
